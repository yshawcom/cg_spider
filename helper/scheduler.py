...
def run_scheduler():
    ...
    scheduler.add_job(TgcwZhaobiaoSpider(tgcwZhaobiaoConst.XMGG).run,
                      id=tgcwZhaobiaoConst.ID_XMGG,
                      name='天工e招 招标公告',
                      timezone=timezone,
                      trigger=trigger,
                      **extra)
    ...
    scheduler.add_job(TgcwZhaobiaoSpider(tgcwZhaobiaoConst.BIDZBGS).run,
                      id=tgcwZhaobiaoConst.ID_BIDZBGS,
                      name='天工e招 中标候选人公示',
                      timezone=timezone,
                      trigger=trigger,
                      **extra)
    ...
    scheduler.add_job(TgcwZhaobiaoSpider(tgcwZhaobiaoConst.BIDZBGG).run,
                      id=tgcwZhaobiaoConst.ID_BIDZBGG,
                      name='天工e招 中标结果公告',
                      timezone=timezone,
                      trigger=trigger,
                      **extra)
